...
Namespace ExcelExport.Interop
    ''' <summary>
    '''     Excel出力
    ''' </summary>
    Public Class ExcelHelperInterop
        Implements IExcelHelperInterop
...
#Region "メソッド(Public)"
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Sub Convert2Export() Implements IExcelHelperInterop.Convert2Export
        End Sub
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Sub Convert2Import() Implements IExcelHelperInterop.Convert2Import
        End Sub
        ...
        ''' </summary>
        ''' <returns></returns>
        Public Function CreateExcelFile() As Boolean Implements IExcelHelperInterop.CreateExcelFile
            Dim blnResult = True
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Sub Export() Implements IExcelHelperInterop.Export
        ...
        '''     取込
        ''' </summary>
        Public Sub Import() Implements IExcelHelperInterop.Import
            ...
            'ファイルを開く
            Dim connExcel As New Data.OleDb.OleDbConnection(strConn)
            connExcel.Open()
        ...
        Public Sub ExportData(dt As Data.DataTable,
                              ByRef xlsWorkCells As Range) Implements IExcelHelperInterop.ExportData
        ...
        Public Sub ExportTitle(dt As Data.DataTable,
                               ByRef xlsWorkCells As Range) Implements IExcelHelperInterop.ExportTitle
        ...
        Public Sub SetDisplayStyle(dt As Data.DataTable,
                                   ByRef xlsWorkSheet As Worksheet) Implements IExcelHelperInterop.SetDisplayStyle
            'データ範囲
