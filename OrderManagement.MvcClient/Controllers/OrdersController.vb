...
Namespace Controllers
    Public Class OrdersController
        ...
        Function Create(<Bind(Include:="OrderId,CustomerId,OrderType,InvoiceNo,OrderDate,ShipDate")> ByVal order As Order) As ActionResult
        ...
        <HttpPost()>
        <ValidateAntiForgeryToken()>
        Function Edit(<Bind(Include:="OrderId,CustomerId,OrderType,InvoiceNo,OrderDate,ShipDate")> ByVal order As Order) As ActionResult
            If ModelState.IsValid Then
